...
## Citation
If you find DeepPCT is useful for your work, please cite our paper (*Improved prediction of post-translational modification crosstalk within proteins using DeepPCT*).
